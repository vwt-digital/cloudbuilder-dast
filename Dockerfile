...
RUN if [ "$TARGET_BRANCH" = "develop" ] ; then pip3 install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ sec-helpers ; else pip3 install sec-helpers; fi
